...
@st.cache_resource
def load_resources():
    with open("C:/Users/yogit/OneDrive/Desktop/DeepLearning/RNN/LSTM/IMDBReviewPredictionUsingLSTM/imdb_tokenizer1.pickle", "rb") as handle:
        tokenizer = pickle.load(handle)
    model = tf.keras.models.load_model("C:/Users/yogit/OneDrive/Desktop/DeepLearning/RNN/LSTM/IMDBReviewPredictionUsingLSTM/IMDB_review_model_ver01.h5")
